...
|----|---------|----------|-------|--------|
| C1 | Warning moves not saveable (`hasValidUnsavedEdit` requires `valid`) | Critical | 1 | Done |
| C2 | Drag vs click validation rules differ | Critical | 1 | Done |
...
| C6 | Click persist immediate, no undo; drag local-only | High | 2, 3 | Done |
| C7 | Stale conflict highlights after undo | High | 3 | Done (enriched snapshots) |
| C8 | Snap vs highlight duration mismatch | Medium | 3 | Done |
