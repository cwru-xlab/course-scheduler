...
export function EditorModalShell({
  ...
  return createPortal(
    <div
      className="fixed inset-0 z-[1050] flex items-center justify-center bg-black/40 p-4 backdrop-blur-[1px]"
      style={{ zIndex: MODAL_Z }}
      role="presentation"
      onClick={onClose}
    >
      <div
        className={`w-full ${maxWidthClass} rounded-2xl border border-slate-200 bg-white shadow-2xl`}
        role="dialog"
        aria-modal="true"
