...
`semester_length`, `prev_notes`, `new_notes`
...
`semester_length` is `Full` (default), `Half (any)`, `First Half`, or `Second Half`. Older workbooks without this column import as Full.
