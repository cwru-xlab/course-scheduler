...
class TestTermAwareFeasibility(unittest.TestCase):
    ...
    def test_two_full_sections_conflict_in_same_room(self) -> None:
        input_data = _half_term_input(term_a="full", term_b="full")
        self.assertFalse(_check_feasible(input_data))
