...
from unified_importer import normalize_id
    ...
    for row in rows:
        ...
        if days and time_range:
            ...
            if pattern_key not in pattern_key_to_pattern:
                pattern_key_to_pattern[pattern_key] = {
                    "id": normalize_id(pattern_key, "default"),
        ...
        if room_str not in room_name_to_room:
            ...
            try:
                ...
                cap = 50
            room_id = normalize_id(room_str, "TBA")
        ...
        if instr_name and instr_name not in instr_name_to_instructor:
            instr_id = normalize_id(instr_name, "unknown")
        ...
        course_id = normalize_id(f"{subject}{catalog_nbr}", section_id)
        ...
        instr_id = normalize_id(instr_name) if instr_name else "unknown"
