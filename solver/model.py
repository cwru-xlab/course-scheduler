...
class Section(db.Model):
    ...
    # Semester length: full | half_any | first_half | second_half
    term = Column(String(16), nullable=False, default="full")
    # Resolved half for half_any sections after placement (first_half | second_half)
